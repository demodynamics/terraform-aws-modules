...
- The public key is stored in AWS under the name eks-ssh-key.
...
This allows you to reference eks-ssh-key when launching EC2 instances (including EKS nodes), enabling SSH 
